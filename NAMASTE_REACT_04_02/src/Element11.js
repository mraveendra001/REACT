...
/*    
   ...
   */   
    return (        
    <>    <Provider store={store}> {/**coming from redux we provided provider a componet for wole app and store passed as prop */}
          {/*created a store .js and provided it to our app*/}
          {/*
