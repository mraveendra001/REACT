    ...
    render(){
        ...
        return (
            ...
            <UserContext.Consumer>
                {
                <h4 className="font-bold p-5 text-xl">
                    {user.name}-{user.email}
                </h4>
                }
            </UserContext.Consumer> {/**this function has he value of whtever the context holds  ,(value)=>console.log(value) we can de structure this line  */}
